...
# Expected order of arguments SECONDS MINUTES HOURS DAYS MESSAGE
...
def set_reminder():
    ...
    if stdout == "Invalid reminder parameters":
        return stdout
    ...
    # Run in background
    message = sys.argv[-1]
    subprocess.Popen([currentPath + '/timeout.sh', seconds, message],
                     cwd="/",
